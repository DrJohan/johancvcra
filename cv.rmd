...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at drjohan.github.io/johancvcra/index.html")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/DrJohan/johancvcra/blob/main/master/drjohan_cv.pdf)")
}
```
