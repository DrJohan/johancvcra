...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at drjohan.github.io/johancracv/index.html")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/DrJohan/johancracv/drjohan_cv.pdf).")
}
```
...
The source code is available <i class="fa fa-github"></i> [Github](https://github.com/DrJohan/johancracv).
Last updated on `r Sys.Date()`. The most recent version of this CV is [available here](drjohan.github.io/johancracv/index.html)
